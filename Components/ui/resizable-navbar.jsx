...
export const NavItem = ({ 
  ...
  return (
    ...
    >
      ...
      >
        {hasDropdown ? (
          <button className="flex items-center gap-2 px-4 py-2.5 rounded-md font-semibold text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-200">
            {children}
            <motion.div
