...
export const BackgroundBeams = React.memo(({ className }) => {
  ...
  return (
    <div
      className={cn(
        "fixed inset-0 z-0 pointer-events-none flex h-full w-full items-center justify-center opacity-30 [mask-repeat:no-repeat] [mask-size:40px]",
        className
      )}
    >
      <svg
        className="pointer-events-none absolute z-0 h-full w-full mix-blend-screen"
        width="100%"
        height="100%"
        viewBox="0 0 696 316"
        fill="none"
      ...
      >
        {/* decorative base path removed to avoid parser limits */}
