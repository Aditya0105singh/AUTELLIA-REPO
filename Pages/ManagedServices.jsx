      ...
      >
        ...
        <div className="absolute inset-0 z-0">
          <img 
            ...
            alt="Support Services Background" 
        ...
        <div className="absolute inset-0 z-10">
          ...
          <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-gradient-to-r from-purple-500/20 to-indigo-600/20 rounded-full blur-3xl animate-pulse delay-1000"></div>
        </div>

        <div className="relative z-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-violet-400 via-purple-500 to-indigo-600 bg-clip-text text-transparent">
              ...
              return (
                <motion.div 
                  ...
                  className={`rounded-2xl p-8 border transition-all duration-300 ${
                    isDark 
                      ? 'bg-gray-800/50 border-gray-700/50 hover:border-violet-500/50' 
                      : 'bg-white/80 border-gray-200 hover:border-violet-400/50 shadow-lg'
                  }`}
                >
