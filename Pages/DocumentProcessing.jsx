    ...
    <div className={`min-h-screen relative overflow-hidden transition-colors duration-500 ${
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div 
          ...
          style={{
            backgroundImage: `url('https://images.unsplash.com/photo-1586281380349-632531db7ed4?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80')`
          }}
        />
        ...
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-gradient-to-r from-red-500/10 to-pink-500/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
      </div>
